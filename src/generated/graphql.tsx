...
export type ScheduledOperationAffectedDocument = Asset | DemoModel | Usuario;
...
export type GetUserWithPassQueryVariables = Exact<{
  email?: InputMaybe<Scalars['String']>;
}>;


export type GetUserWithPassQuery = { __typename?: 'Query', usuario?: { __typename?: 'Usuario', name?: string | null, password?: string | null } | null };
...
export type GetUserQuery = { __typename?: 'Query', usuario?: { __typename?: 'Usuario', name?: string | null } | null };


export const GetUserWithPassDocument = gql`
...
/**
 * __useGetUserWithPassQuery__
 *
 * To run a query within a React component, call `useGetUserWithPassQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUserWithPassQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserWithPassQuery({
 *   variables: {
 *      email: // value for 'email'
 *   },
 * });
 */
export function useGetUserWithPassQuery(baseOptions?: Apollo.QueryHookOptions<GetUserWithPassQuery, GetUserWithPassQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserWithPassQuery, GetUserWithPassQueryVariables>(GetUserWithPassDocument, options);
      }
export function useGetUserWithPassLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserWithPassQuery, GetUserWithPassQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserWithPassQuery, GetUserWithPassQueryVariables>(GetUserWithPassDocument, options);
        }
export type GetUserWithPassQueryHookResult = ReturnType<typeof useGetUserWithPassQuery>;
export type GetUserWithPassLazyQueryHookResult = ReturnType<typeof useGetUserWithPassLazyQuery>;
export type GetUserWithPassQueryResult = Apollo.QueryResult<GetUserWithPassQuery, GetUserWithPassQueryVariables>;
